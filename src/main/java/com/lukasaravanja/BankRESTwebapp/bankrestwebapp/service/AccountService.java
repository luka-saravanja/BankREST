...
public class AccountService  {
	...
	public void depositMoney(int accountNumber,double amount)
	{
		...
		else if((User)account.getUser()!=user)
	...
	public void transferMoney(int accountNumberSource,int accountNumberDestination,double amount)
	{
		...
		Accounts accountSource = accountsRepository.findByAccountNumber(accountNumberDestination);
		...
		else if((User)accountSource.getUser() != userSource)
